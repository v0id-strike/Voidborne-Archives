...
- **Recommended Adapters**:
  ...
  - TP-Link Archer T4U (Budget option)
- **Antennas**: High-gain directional for wardriving

### **Kali Linux Preparation**
```bash
sudo apt update && sudo apt install aircrack-ng hashcat hcxdumptool bully reaver
